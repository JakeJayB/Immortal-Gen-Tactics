...
public class CanvasUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UnitDisplay.GetComponent<RectTransform>().anchoredPosition = new Vector2(200, 70);
        ...
        TargetUnitDisplay.GetComponent<RectTransform>().anchoredPosition = new Vector2(-200, 70);
