...
public class UnitMenu : MonoBehaviour
{
    ...
    public static void DisplayUnitMenu(Unit unit)
    {
        ...
        var actions = ChainSystem.ReactionInProgress ? unit.ActionSet.GetAllReactions() : unit.ActionSet.GetAllTurnActions();
    ...
    {
        CameraMovement.SetFocusPoint(TileLocator.SelectableTiles[unit.UnitInfo.Vector2CellLocation()].TileObj.transform);
