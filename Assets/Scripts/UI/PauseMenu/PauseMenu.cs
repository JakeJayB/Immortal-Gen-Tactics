...
public class PauseMenu : MonoBehaviour
{
    ...
    private void CreateButton(string name, Transform parent, string label, Vector2 position, Vector2 anchor, UnityEngine.Events.UnityAction onClick)
    {
        // button root
    ...
    private TMP_Text CreateText(string name, Transform parent, string content)
    {
